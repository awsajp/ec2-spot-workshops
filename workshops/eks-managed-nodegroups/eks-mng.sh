...
aws ec2 create-launch-template-version \
        --launch-template-name eks-mang-lt \
        --version-description "add security groups" \
        --source-version 1 \
        --launch-template-data '{"SecurityGroupIds":["sg-0acd7f4f4cdacc8fe", "sg-09ccb109142513b5a"]}'


aws eks update-nodegroup-version \
        --cluster-name eksworkshop \
        --nodegroup-name  ekscluster-mng-custome \
        --launch-template name=eks-mang-lt,version=3
